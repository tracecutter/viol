...
from viol.lib.compat import WINDOWS
...
def setup_logging(verbosity=0, no_color=False, user_log_file=None):
    ...
    handler_classes = {
        "stream": "viol.lib.log.ColorizedStreamHandler",
        "file": "viol.lib.log.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "viol.lib.log.MaxLevelFilter",
                "level": logging.WARNING,
            },
            "restrict_to_subprocess": {
                "()": "logging.Filter",
                "name": "viol.subprocessor",
            },
            "exclude_subprocess": {
                "()": "viol.lib.log.ExcludeLoggerFilter",
                "name": "viol.subprocessor",
            },
        },
        "formatters": {
