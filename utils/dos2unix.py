...
-n (--nobackup) No backup. Does not make a ".bak" file before dos2unixing.
-v (--verbose)  Verbose.   Print informative msgs; else no output.
-h (--help)     Help.      Print this usage information and exit.

Convert files to use Unix <CR> line endings.

If no paths are given on the command line, dos2unix operates as a filter,
...
If output is not to standard output, dos2unix overwrites files in place,
renaming the originals with a .bak extension.  If it finds nothing to
change, the file is left alone.  If dos2unix does change a file, the changed
file is a fixed-point for future runs (i.e., running dos2unix on the
